...
var markers = [];
var windows = [];
var image = 'https://maps.google.com/mapfiles/kml/shapes/airports_maps.png';
var airports = [];
...
// var icons = {
//   plane: {
//     icon: 'https://maps.google.com/mapfiles/kml/shapes/airports_maps.png',
//   }
// };
  ...
  socket.on('POSITION', function(data){
    ...
    for (var i = 0; i < markers.length; i++) {
      if(markers[i]!= null && markers[i]['code']==data['code']){
        ...
        // auxIcon.rotation = heading;
        // auxIcon.rotation = 45;
        markers[i]['marker'].setIcon(auxIcon);
        // if(lastPosn!=null){
        //   console.log(lastPosn);
        //   console.log(myLatLng);
        //   var heading = google.maps.geometry.spherical.computeHeading(lastPosn,myLatLng);
    ...
    // var auxIcon = {url:image};
    // if(lastPosn!=null){
    //   console.log(lastPosn);
    //   console.log(myLatLng);
    //   var heading = google.maps.geometry.spherical.computeHeading(lastPosn,myLatLng);
    //     auxIcon.rotation = heading;
    //       marker.setIcon(auxIcon);
    // }
